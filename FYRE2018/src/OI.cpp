...
OI::OI() {
    ...
    xBoxButton8.reset(new frc::JoystickButton(xBox.get(), 8));
    xBoxButton8->WhenPressed(new SwitchDriveMethod());
    xBoxButton1.reset(new frc::JoystickButton(xBox.get(), 1));
    ...
    logitechButton11->WhenPressed(new WindServo());
