...
OI::OI() {
    ...
    logitechButton8.reset(new frc::JoystickButton(logitech.get(), 12));
    logitechButton8->WhenPressed(new UnwindServo());
    logitechButton7.reset(new frc::JoystickButton(logitech.get(), 11));
    logitechButton7->WhenPressed(new WindServo());
