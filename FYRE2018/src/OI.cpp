...
OI::OI() {
    ...
    logitechButton8.reset(new frc::JoystickButton(logitech.get(), 8));
    logitechButton8->WhileHeld(new UnwindServo());
    logitechButton7.reset(new frc::JoystickButton(logitech.get(), 7));
    logitechButton7->WhileHeld(new WindServo());
